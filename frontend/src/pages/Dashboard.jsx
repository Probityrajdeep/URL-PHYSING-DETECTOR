...
import ThreatIntelligenceTab from "../components/dashboard/ThreatIntelligenceTab.jsx";

ChartJS.register(CategoryScale, LinearScale, PointElement, LineElement, Tooltip, Filler, Legend);

const SIDEBAR_LINKS = ["Overview", "Scan History", "Threat Intelligence"];
          ...
          {activeNav === "Overview" ? (
            ...
            <>
              <motion.div
                ...
                className="rounded-xl border border-cyan-300/20 bg-cyan-500/[0.08] px-4 py-3 text-sm text-cyan-100 backdrop-blur-xl"
              >
                    ...
                    <tbody>
                      {scanHistory.length === 0 ? (
                        ...
                        scanHistory.map((row) => {
                          ...
                          const confPct = formatConfidence(row.confidence);
                          return (
